...
class HotReloader:
    ...
    def _refresh_registry(self):
        ...
        try:
            ...
            importlib.reload(backend.registry)

            # Reload handlers (re-executes @register decorators)
    ...
    def _filepath_to_module(self, filepath: str) -> Optional[str]:
        ...
        # Check if it's in the backend directory
        backend_dir = os.path.join(PROJECT_ROOT, "backend")
        if filepath.startswith(backend_dir):
